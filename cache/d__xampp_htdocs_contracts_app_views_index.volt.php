...
<html>
    <head>
        ...
        <?php switch ($this->cookies->get('contracts-theme')): ?>
<?php case 'superhero': ?>
...
<?php endswitch ?>
        ...
        <?= $this->tag->stylesheetlink('css/my_classes.css') ?>
    </head>
    <body>
    <div class="d-flex flex-column" style="min-height: 100vh;">
        <?php $userType = $di->get('session')->auth['role']; ?>
        <?php if ($userType == null) { ?>
            <?php $userType = 'guest'; ?>
        <?php } ?>
        <?= $this->partial('shared/header/' . $userType) ?>
