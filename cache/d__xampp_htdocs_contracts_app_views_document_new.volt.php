...
<?= $this->tag->form(['document/create', 'method' => 'post', 'enctype' => 'multipart/form-data', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <?= $this->tag->textField(['contract', 'class' => 'form-control', 'id' => 'contract']) ?>
    </div>
</div>
